...
try {
  fs.writeFileSync('C:/Users/hazem/Downloads/matger2/src/app/admin/dashboard/DashboardClient.tsx', code, 'utf8');
  console.log('Successfully wrote reconstructed DashboardClient.tsx!');
} catch (err) {
