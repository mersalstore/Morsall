          ...
          <div className="animate-fade-in-up">
            ...
            {step === 3 && (
              <div className="space-y-8 text-right">
                ...
                <div className="space-y-4">
                  {[
                    { id: "BASIC", name: "الباقة التجريبية المجانية", price: "مجاناً", desc: "تجربة مجانية لمدة 14 يوم — شكل المتجر افتراضي بدون تخصيص.", features: ["14 يوم تجربة مجانية", "حد أقصى 10 منتجات", "تصميم متجر افتراضي"] },
                    { id: "PRO", name: "Premium Builder", price: "حسب الإعدادات", desc: "محرر متجر SaaS كامل — رفع بانر، تحرير الترحيب، اختيار منتجات مميزة.", features: ["محرر SaaS كامل", "بانر مخصص + منتجات مميزة", "حد منتجات قابل للضبط من الإدارة"] },
                    { id: "ELITE", name: "Custom Design — فريق Vixcell", price: "حسب الإعدادات", desc: "فريق متخصص من Vixcell يصمم متجرك. منتجات بلا حدود + تواصل مباشر مع الفريق.", features: ["فريق Vixcell مخصص", "منتجات بلا حدود", "تواصل مباشر لتصميم متجرك"] },
                  ].map((p) => (
                    <div key={p.id}
