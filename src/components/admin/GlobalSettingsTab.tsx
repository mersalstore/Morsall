    ...
    <form onSubmit={handleSave} className="space-y-12">
      <div className="flex justify-between items-center bg-white p-10 rounded-[3rem] border border-gray-100 shadow-2xl shadow-gray-200/50">
         <div className="flex items-center gap-6">
            ...
            <div>
               <h2 className="text-3xl font-black text-[#021D24]">الإعدادات العامة</h2>
         ...
         <button 
           type="submit"
           disabled={saving}
           className="bg-[#021D24] text-white px-12 py-5 rounded-[1.5rem] font-black text-sm shadow-xl hover:bg-[#1089A4] transition-all flex items-center gap-4 active:scale-95 disabled:opacity-50"
         >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
         ...
         <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-2xl space-y-10">
            <div className="flex items-center gap-4 text-[#1089A4]">
               <Percent size={24} />
               <h3 className="text-xl font-black text-[#021D24]">اقتصاديات المنصة</h3>
            </div>
         ...
         <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-2xl space-y-10">
            <div className="flex items-center gap-4 text-[#F29124]">
               <Globe size={24} />
               <h3 className="text-xl font-black text-[#021D24]">الهوية وتحسين المحركات</h3>
            </div>
