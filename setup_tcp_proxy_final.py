...
FINAL_HTACCESS = """# Disable Passenger
...
# 4. Proxy virtual routes to Node on port 3000
...
def setup_final():
    try:
        ...
        # 1. Kill old processes and socket
        print("Cleaning up old processes...")
        client.exec_command("pkill -9 -u u754458241 -f node; pkill -9 -u u754458241 -f passenger; rm -f /home/u754458241/node.sock", timeout=10)
        time.sleep(2)
        
        # 2. Write updated .htaccess to both public_html dirs
        sftp = client.open_sftp()
        for path in [
            '/home/u754458241/domains/morsall.com/public_html/.htaccess',
            '/home/u754458241/public_html/.htaccess'
        ]:
            print(f"Writing final proxy .htaccess to {path}...")
            with sftp.file(path, 'w') as f:
                f.write(FINAL_HTACCESS)
        sftp.close()
